...
@Deprecated //This will be removed in the next commit
public class OldSearchPaginator {
    ...
    public OldSearchPaginator(MediaSearch searchResults, Message message) {
    ...
    public OldSearchPaginator(MediaSearch searchResults, SlashCommandEvent event){
        this.searchResults = searchResults;
        this.message = null;
        this.event = event;
